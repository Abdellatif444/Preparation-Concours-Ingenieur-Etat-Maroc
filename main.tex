...
\title{GUIDE DE PRÉPARATION INTENSIVE\\CONCOURS DE RECRUTEMENT DES INGÉNIEURS D'ÉTAT (1\textsuperscript{ER} GRADE)\\[0.3cm]\Large MINISTÈRE DES AFFAIRES ÉTRANGÈRES, DE LA COOPÉRATION AFRICAINE\\ET DES MAROCAINS RÉSIDANT À L'ÉTRANGER}
\author{
...
\department{Ministère des Affaires Étrangères, de la Coopération Africaine et des Marocains Résidant à l'Étranger (MAECAME)}
\filiere{Préparation Intensive \& Annales d'Épreuves Écrites}

\supervisor{
    \hspace{0.5cm}$\blacktriangleright$ Ministère des Affaires Étrangères, de la Coopération Africaine et des MRE\\[0.1cm]
    \hspace{0.5cm}$\blacktriangleright$ Commission Centrale des Concours
}
\academicyear{\textbf{Session du 27 Septembre 2026 --- Salé}}
...
\AtBeginDocument{%
  ...
  \pagestyle{fancy}
  \fancyhf{}
  \fancyhead[L]{\small\textbf{\textsf{MAECAME --- Concours Ingénieurs d'État (1\textsuperscript{er} Grade)}}}
...
\input{chapters/1_methodologie_epreuve}
\input{chapters/2_annales_dissertation}

% --- DEUXIÈME PARTIE : BANQUE DE QUESTIONS ET FICHES RÉVISIONS ---
\part{BANQUE DE QUESTIONS / RÉPONSES ET FICHES MÉMOTECHNIQUES}

\input{chapters/3_banque_questions_qcm}
\input{chapters/4_fiches_revisions_mef}

% --- TROISIÈME PARTIE : STRATÉGIE JOUR J ET PLANNING D'URGENCE ---
\part{STRATÉGIE JOUR J ET PLANNING D'URGENCE}

\input{chapters/5_planning_intensif}
\input{chapters/6_examen_blanc}
