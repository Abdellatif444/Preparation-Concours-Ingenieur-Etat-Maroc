...
Cette équation indique que la somme de la variation temporelle de la masse contenue dans le volume de contrôle et du flux massique à travers sa surface est nulle. Par application de la formule de divergence, on obtient la forme locale de l'équation de continuité : \cite{panton2013incompressible}
